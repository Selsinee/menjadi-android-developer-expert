...
class AnimeRepository(
    ...
    override fun getAllAnimes(): Flow<Resource<List<Anime>>> =
        object :
            com.dicoding.animelist.core.data.NetworkBoundResource<List<Anime>, List<AnimeResponse>>() {
            ...
            override fun shouldFetch(data: List<Anime>?): Boolean = data == null || data.isEmpty()
